...
def download(link, name='%(title)s'):
    ydl_opts = {
        ...
        'outtmpl': 'C:\\Yandex_Disc_Syn\\YandexDisk\\work files\\youtube\\{}.%(ext)s'.format(name), #наше выбраное имя, если его не было, то стандартное - название видео на самом сайте
    }
